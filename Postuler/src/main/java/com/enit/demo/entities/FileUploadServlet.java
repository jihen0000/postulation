...
public class FileUploadServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String fileUrl = "http://localhost:9090/uploaded-files/" + filePart.getSubmittedFileName();
		...
		response.getOutputStream().println("<p>Upload another file <a href=\"http://localhost:9090/index.html\">here</a>.</p>");	
	}
}
